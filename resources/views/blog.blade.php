...
<body>
    ...
    <section class="hero-area">
        ...
        <div class="hero-post-slides owl-carousel">
            ...
            <div class="single-hero-post d-flex flex-wrap">
                <!-- Post Thumbnail -->
                <div class="slide-post-thumbnail h-100 bg-img" style="background-image: {{ 'url(./assets/img/blog-img/14.jpg)'}};"></div>
                <!-- Post Content -->
                <div class="slide-post-content h-100 d-flex align-items-center">
                    <div class="slide-post-text">
                        <p class="post-date" data-animation="fadeIn" data-delay="100ms">MAY 01, 2018 / lifestyle</p>
            ...
            <div class="single-hero-post d-flex flex-wrap">
                <!-- Post Thumbnail -->
                <div class="slide-post-thumbnail h-100 bg-img" style="background-image: {{ 'url(./assets/img/blog-img/15.jpg)'}};"></div>
                <!-- Post Content -->
                <div class="slide-post-content h-100 d-flex align-items-center">
                    <div class="slide-post-text">
                        <p class="post-date" data-animation="fadeIn" data-delay="100ms">MAY 01, 2018 / lifestyle</p>
                            ...
                            <div class="col-12">
                                <div class="featured-post-area mb-50">
                                    ...
                                    <div class="post-thumbnail mb-30">
                                        <a href="#"><img src=" {{ $posts[0]->gambar }}" alt=""></a>
                                    </div>
                                    <!-- Featured Post Content -->
                                    <div class="featured-post-content">
                                        <p class="post-date">{{ $posts[0]->created_at->diffFOrHumans()}} / {{ $posts[0]->category->name}}</p>
                                        <a href="#" class="post-title">
                                            <h2>{{ $posts[0]->judul}}</h2>
                                        </a>
                                        <p class="post-excerpt">{{ $posts[0]->content}} </p>
                                    </div>
                                    <!-- Post Meta -->
                                    <div class="post-meta d-flex align-items-center justify-content-between">
                                        <!-- Author Comments -->
                                        <div class="author-comments">
                                            <a href="#"><span>by</span> <b> {{ $posts[0]->users->name }}</b></a>
                                        </div>
                                        <!-- Social Info -->
                                        <div class="social-info">
                                            <a href="#" class=""> #{{$posts[0]->tags[0]->name }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    ...
                                    <div class="post-thumbnail">
                                        <a href="#">
                                            <img src=" {{$post->gambar}}" alt="" style="max-height: 250px"></a>
                                    </div>
                                    <!-- Content -->
                                    <div class="post-content">
                                        <p class="post-date"> {{ $post->created_at->diffForHumans()}} / {{ $post->category->name}}</p>
                                        <a href="#" class="post-title">
                                            <h4> {{ $post->judul}}</h4>
                                        </a>
                    ...
                    <div class="post-sidebar-area">
                        ...
                        <div class="single-widget-area mb-30">
                            ...
                            <div class="about-thumbnail">
                                <img src=" {{ asset('./assets/img/blog-img/about-me.jpg')}}" alt="">
                            </div>
                            <!-- Content -->
                            <div class="widget-content text-center">
                                <img src="{{ asset('./assets/img/blog-img/signature.jpg')}}" alt="">
                        ...
                        <div class="single-widget-area mb-30">
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="{{ asset('./assets/img/blog-img/lp5.jpg')}}" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                        ...
                        <div class="single-widget-area mb-30">
                            <!-- Adds -->
                            <a href="#"><img src="{{ asset('./assets/img/blog-img/add.png')}}" alt=""></a>
                        </div>
    ...
    <div class="follow-us-instagram">
        <div class="instagram-content d-flex flex-wrap align-items-center">
            ...
            <div class="single-instagram">
                <img src="{{ asset('./assets/img/blog-img/insta1.jpg')}}" alt="">
                <a href="#"><i class="fa fa-instagram"></i></a>
            </div>

            <!-- Single Instagram Slide -->
            <div class="single-instagram">
                <img src="{{ asset('./assets/img/blog-img/insta2.jpg')}}" alt="">
                <a href="#"><i class="fa fa-instagram"></i></a>
            </div>

            <!-- Single Instagram Slide -->
            <div class="single-instagram">
                <img src="{{ asset('./assets/img/blog-img/insta3.jpg')}}" alt="">
                <a href="#"><i class="fa fa-instagram"></i></a>
            </div>

            <!-- Single Instagram Slide -->
            <div class="single-instagram">
                <img src="{{ asset('./assets/img/blog-img/insta4.jpg')}}" alt="">
                <a href="#"><i class="fa fa-instagram"></i></a>
            </div>

            <!-- Single Instagram Slide -->
            <div class="single-instagram">
                <img src="{{ asset('./assets/img/blog-img/insta5.jpg')}}" alt="">
                <a href="#"><i class="fa fa-instagram"></i></a>
            </div>

            <!-- Single Instagram Slide -->
            <div class="single-instagram">
                <img src="{{ asset('./assets/img/blog-img/insta6.jpg')}}" alt="">
                <a href="#"><i class="fa fa-instagram"></i></a>
            </div>

            <!-- Single Instagram Slide -->
            <div class="single-instagram">
                <img src="{{ asset('./assets/img/blog-img/insta7.jpg')}}" alt="">
                <a href="#"><i class="fa fa-instagram"></i></a>
            </div>

            <!-- Single Instagram Slide -->
            <div class="single-instagram">
                <img src="{{ asset('./assets/img/blog-img/insta8.jpg')}}" alt="">
                <a href="#"><i class="fa fa-instagram"></i></a>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="copywrite-text">
                        <p>
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Bekasi <i class="fa fa-heart-o" aria-hidden="true"></i></p>
                    </div>
                </div>
            </div>
        </div>
